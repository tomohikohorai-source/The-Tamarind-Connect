...
export const SAMPLE_MARKET_ITEMS: MarketItem[] = [
  {
    ...
    roomNumber: 'A-12-03',
    parentAvatarIcon: '👩',
    title: 'Baby Stroller (Good Condition)',
    genre: 'Baby & Kids',
    description: 'Used for 1 year, still in very good condition. Lightweight and easy to fold.',
    price: 150,
    type: 'SALE',
    status: 'AVAILABLE',
    requestStatus: 'NONE',
    ...
    condition: 'A',
    comments: [],
    images: ['https://images.unsplash.com/photo-1519689680058-324335c77eba?auto=format&fit=crop&q=80&w=400'],
...
export const SAMPLE_WANTED_ITEMS: WantedItem[] = [
  {
    ...
    images: ['https://images.unsplash.com/photo-1622279457486-62dcc4a4bd13?auto=format&fit=crop&q=80&w=400'],
    comments: [],
    status: 'OPEN',
    createdAt: new Date().toISOString(),
    lastUpdated: new Date().toISOString()
